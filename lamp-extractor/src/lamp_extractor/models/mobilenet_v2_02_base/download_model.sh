#!/bin/bash
cd "F:/aston/machine-learning/lamp-extractor/src/lamp_extractor/models/mobilenet_v2_02_base"
MACHINE=developer@192.168.100.10
DATA_PATH=/home/developer/ml/projects/lamp-extractor-dl/out_corner/mobilenet_v2_02_base
